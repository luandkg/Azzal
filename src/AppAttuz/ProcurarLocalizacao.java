...
import AppAttuz.Localizador.Escurcao;
import AppAttuz.Localizador.Visita;
...
public class ProcurarLocalizacao {
    ...
    public String ondeEstou(Viajante EU, Tozte eTozte, Hazde eHazde) {
        ...
        //String arqCache = FS.getArquivoLocal("Tronarko/Cache.txt");
        //String arqTronarko = FS.getArquivoLocal("Tronarko/" + "t" + eTozte.getTronarko() + ".txt");

        // if (!FS.arquivoExiste("Tronarko", "t" + eTozte.getTronarko() + ".txt")) {
    ...
    public String procurando(DKG eDKG, Viajante EU, Tozte eTozte, Hazde eHazde) {
        ...
        if (isVisitando) {
            Visita.onVisita(eTozte, eHazde, visita_comecar);
        }

        if (isViajando) {
            Escurcao.onEscurcao(eTozte, eHazde, viagem_comecar);
        }
