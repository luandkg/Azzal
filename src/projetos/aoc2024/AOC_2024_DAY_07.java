...
public class AOC_2024_DAY_07 extends AOC_2024_DAY {
    ...
    public void parte_2() {
        ...
        for (String equacao : Strings.DIVIDIR_LINHAS(texto_entrada)) {
            ...
            final String OPERADOR_TIPO_SOMA = "+";
            final String OPERADOR_TIPO_PRODUTO = "*";
            final String OPERADOR_TIPO_COMBINADOR = "|";

            Lista<String> operadores_permitidas = new Lista<String>();
            operadores_permitidas.adicionar(OPERADOR_TIPO_SOMA);
            operadores_permitidas.adicionar(OPERADOR_TIPO_PRODUTO);
            operadores_permitidas.adicionar(OPERADOR_TIPO_COMBINADOR);
            ...
            Vetor<String> operadores_permutacoes = Matematica.PERMUTACOES_EM_VETOR(operadores_desconhecidos, operadores_permitidas, Strings.CONCATENADOR());
            ...
            for (String operadores_permutacao : operadores_permutacoes) {
                ...
                for (String operador_corrente : Strings.GET_LETRAS(operadores_permutacao)) {
                    ...
                    if (Strings.isIgual(operador_corrente, OPERADOR_TIPO_SOMA)) {
                        ...
                        operacao_resultado *= numero_corrente;
                    } else if (Strings.isIgual(operador_corrente, OPERADOR_TIPO_COMBINADOR)) {
                        String novo_numero = String.valueOf(operacao_resultado) + String.valueOf(numero_corrente);
                        operacao_resultado = Long.parseLong(novo_numero);
                    }
                ...
                if (tem_alguma_ok) {
                    fmt.print("\t >> Sair antes porque já encontrei uma equação com resultado !!");
                   break;
                }
        ...
        info(getParte(), somatorio_correto);
