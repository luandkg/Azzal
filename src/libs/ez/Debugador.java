...
public class Debugador {
    ...
    public static void debug_colecionador(AQColecionador AQColecionador) {
        debug_momentum(AQColecionador.getMomentum());
    }

    public static void debug_colecionador_completo(AQColecionador AQColecionador) {

        Debugador.debug_colecionador(AQColecionador);
        for (Banco banco : AQColecionador.getMomentum().getBancos()) {
