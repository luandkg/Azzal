...
public class LocalCache {
    ...
    public static long getItensEmCacheContagem(Arquivador mArquivador, long mLocalCache) {
        ...
        for (int item_do_cache = 0; item_do_cache < libs.armazenador.Armazenador.MAX_ITENS_DO_CACHE; item_do_cache++) {
    ...
    public static void guardar(Arquivador mArquivador, long obter_item_do_cache, String conteudo) {
        ...
        if (item_status == libs.armazenador.Armazenador.ITEM_NAO_ALOCADO) {
            ...
            libs.armazenador.ItemGuardar.guardar_em_item_nao_alocado(mArquivador, obter_item_do_cache, ponteiro_guardar, conteudo);
