...
public class Banco {
    ...
    public long getLimiteContagem() {
        ...
        for (Long capitulo_ponteiro : sumario.getCapitulosUtilizados()) {
            Sumario.realizar_contagem_de_limite_no_capitulo(mArquivador, this, capitulo_ponteiro, contando);
    ...
    public long adicionar(Entidade conteudo) {
        return adicionar(ENTT.TO_DOCUMENTO(conteudo));
    }
    ...
    public Opcional<ItemDoBanco> obter_opcional(String att_nome, String att_valor) {
