...
public class ItemGuardar {
    ...
    public static long TAMANHO_ITEM = 10 * 1024;
    ...
    public static void guardar_em_item_nao_alocado(Arquivador mArquivador, long ponteiro_item, long ponteiro_guardar, String conteudo) {
        ...
        mArquivador.set_u8_em_bloco(TAMANHO_ITEM, (byte) 0);
        ...
        mArquivador.set_u8((byte) libs.armazenador.Armazenador.ITEM_ALOCADO_OCUPADO);
