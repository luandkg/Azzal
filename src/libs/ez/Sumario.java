...
public class Sumario {
    ...
    public static void realizar_contagem_de_paginas_limite_no_capitulo(Arquivador mArquivador, Banco mBanco, long capitulo_ponteiro, RefLong contador) {

        for (Long pagina_ponteiro : Paginador.getPaginasUtilizadasDoCapitulo(mArquivador, capitulo_ponteiro)) {
            Pagina pg = new Pagina(mArquivador, mBanco, pagina_ponteiro);
            contador.set(contador.get() + pg.contagemLimite());
        }
    ...
    public static void realizar_contagem_de_limite_no_capitulo(Arquivador mArquivador, Banco mBanco, long capitulo_ponteiro, RefLong contador) {

        for (Long pagina_ponteiro : Paginador.getPaginasUtilizadasDoCapitulo(mArquivador, capitulo_ponteiro)) {
            Pagina pg = new Pagina(mArquivador, mBanco, pagina_ponteiro);
            contador.set(contador.get() + Armazenador.MAX_ITENS_POR_PAGINA);
        }
