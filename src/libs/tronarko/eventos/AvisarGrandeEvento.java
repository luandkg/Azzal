...
public class AvisarGrandeEvento {
    ...
    public static Ordenavel<AvisarGrandeEvento> ORDENAVEL(){
        return new Ordenavel<AvisarGrandeEvento>() {
            @Override
            public int emOrdem(AvisarGrandeEvento a, AvisarGrandeEvento b) {
