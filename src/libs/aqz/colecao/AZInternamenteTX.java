...
public class AZInternamenteTX {

    // LUAN FREITAS
    // IDEALIZADO EM : 2024 01 04
    // RE-IMPLEMENTADO EM 2024 11 10

    private Armazenador mArmazenador;

    public static final String AQZ_INIT = "@Init";

    public static final String COLECOES_DADOS = "@ColecoesTX::Dados";
    public static final String COLECOES_SEQUENCIAS = "@ColecoesTX::Sequencias";


    public AZInternamenteTX(String arquivo_banco) {
    ...
    public AZInternamenteTX(Armazenador eArmazenador) {
    ...
    public void colecoes_criar(String colecao_nome) {
        ...
        String coluna_nome_sequenciador="TX";
