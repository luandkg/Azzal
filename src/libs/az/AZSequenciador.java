...
public class AZSequenciador {
    ...
    public static void organizar_sequencial(Banco eBanco, String eNome) {
        ...
        if (item_objeto_contador.temValor()) {
            AZSequenciador.sequencia(item_objeto_contador.get());
        } else {
            AZSequenciador.criar_sequencial(eBanco, eNome, 0, 1);
        }
    ...
    public static int get_sequencial_contador(Banco eBanco, String eNome) {
        ...
        if (item_objeto_contador.temValor()) {
            ret = AZSequenciador.sequencia(item_objeto_contador.get());
        } else {
            AZSequenciador.criar_sequencial(eBanco, eNome, 0, 1);
            ret = 0;
        }
