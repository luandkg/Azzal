...
public class AnalisadorClimatico {
    ...
    public static void INIT() {
        ...
        ENTT.EXIBIR_TABELA(ENTT.GET_AMOSTRA_PEQUENA(sensores_hiperestacoes));
    ...
    public static void parte_2(Lista<Entidade> sensores_hiperestacoes){
        ...
        ENTT.EXIBIR_TABELA(estacoes_combinacoes);
    ...
    public static void parte_4() {
        ...
        ENTT.EXIBIR_TABELA(ENTT.DISPERSAO(sensores_hiperestacoes, "Hiperestacao"));
