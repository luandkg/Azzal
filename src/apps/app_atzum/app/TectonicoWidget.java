...
public class TectonicoWidget {
    ...
    public void render(Renderizador g, int descritor_py) {
        ...
        ESCRITOR_NORMAL.escreva(temperatura_px_original, temperatura_py - 65, "MAPA TECTÔNICO");
        ...
        for (int s = 1; s <= 500; s++) {
            ...
            if (acontecimentos.possuiObjetos()) {
                ...
                } else if (acontecimentos_terremoto.getQuantidade() == 0 && acontecimentos_vulcanismo.getQuantidade() > 0) {
                    acontecimento_cor = mCores.getVermelho();
                }
                ...
                if (mCidade.isOK()) {
                    ...
                    for (Entidade terremoto : acontecimentos_terremoto) {
                        ...
                        int distancia = Espaco2D.distancia_entre_pontos(mCidade.get().atInt("X"), mCidade.get().atInt("Y"), terremoto.atInt("X"),terremoto.atInt("Y"));
                    ...
                    for (Entidade vulcanismo : acontecimentos_vulcanismo) {
                        ...
                        int distancia = Espaco2D.distancia_entre_pontos(mCidade.get().atInt("X"), mCidade.get().atInt("Y"), vulcanismo.atInt("X"),vulcanismo.atInt("Y"));
    ...
    public void render_superarko_info(int superarko, Renderizador g, int pos_y) {
        ...
        ESCRITOR_NORMAL.escreva(220, pos_y, "T = " + Portugues.VALIDAR(acontecimentos_terremoto.possuiObjetos(), "SIM", "NÃO"));
        ESCRITOR_NORMAL.escreva(320, pos_y, "V = " + Portugues.VALIDAR(acontecimentos_vulcanismo.possuiObjetos(), "SIM", "NÃO"));
