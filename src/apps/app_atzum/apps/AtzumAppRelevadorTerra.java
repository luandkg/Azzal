...
public class AtzumAppRelevadorTerra extends Cena {
    ...
    private String ARQUIVO_RELEVO = LOCAL + "RELEVO_TERRA.dkg";
    ...
    public void iniciar(Windows eWindows) {
      ...
      //  AtzumCreator.NORMALIZAR_2_CORES_ABAIXO_DE(render2, 100, mCores.getVermelho(), mCores.getPreto());
        ...
        BotaoCor BTN_0 = mClicavel.criarBotaoCor(new BotaoCor(300, 50, 50, 50, EscalaRT3.T0));
        ...
        BotaoCor BTN_1 = mClicavel.criarBotaoCor(new BotaoCor(400, 50, 50, 50, EscalaRT3.T1));
        ...
        BotaoCor BTN_2 = mClicavel.criarBotaoCor(new BotaoCor(500, 50, 50, 50, EscalaRT3.T2));
        ...
        BotaoCor BTN_3 = mClicavel.criarBotaoCor(new BotaoCor(600, 50, 50, 50, EscalaRT3.T3));
        ...
        BotaoCor BTN_4 = mClicavel.criarBotaoCor(new BotaoCor(700, 50, 50, 50, EscalaRT3.T4));
        ...
        BotaoCor BTN_5 = mClicavel.criarBotaoCor(new BotaoCor(800, 50, 50, 50, EscalaRT3.T5));
        ...
        BotaoCor BTN_6 = mClicavel.criarBotaoCor(new BotaoCor(900, 50, 50, 50, EscalaRT3.T6));
        ...
        BotaoCor BTN_7 = mClicavel.criarBotaoCor(new BotaoCor(1000, 50, 50, 50, EscalaRT3.T7));
        ...
        BotaoCor BTN_8 = mClicavel.criarBotaoCor(new BotaoCor(1100, 50, 50, 50, EscalaRT3.T8));
        ...
        BotaoCor BTN_9 = mClicavel.criarBotaoCor(new BotaoCor(1200, 50, 50, 50, EscalaRT3.T9));
        ...
        BotaoCor BTN_10 = mClicavel.criarBotaoCor(new BotaoCor(1300, 50, 50, 50, EscalaRT3.T10));
        ...
        BotaoCor BTN_11 = mClicavel.criarBotaoCor(new BotaoCor(1400, 50, 50, 50, EscalaRT3.T11));
        ...
        BotaoCor BTN_12 = mClicavel.criarBotaoCor(new BotaoCor(1500, 50, 50, 50, EscalaRT3.T12));
