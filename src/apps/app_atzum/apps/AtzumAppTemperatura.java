...
public class AtzumAppTemperatura extends Cena {
    ...
    private String ARQUIVO_RELEVO = LOCAL + "TEMPERATURA.dkg";
    ...
    public void iniciar(Windows eWindows) {
        ...
        BotaoCor BTN_0 = mClicavel.criarBotaoCor(new BotaoCor(300, 50, 25, 25, EscalaRT3.T0));
        ...
        BotaoCor BTN_1 = mClicavel.criarBotaoCor(new BotaoCor(350, 50, 25, 25, EscalaRT3.T1));
        ...
        BotaoCor BTN_2 = mClicavel.criarBotaoCor(new BotaoCor(400, 50, 25, 25, EscalaRT3.T2));
        ...
        BotaoCor BTN_3 = mClicavel.criarBotaoCor(new BotaoCor(450, 50, 25, 25, EscalaRT3.T3));
        ...
        BotaoCor BTN_4 = mClicavel.criarBotaoCor(new BotaoCor(500, 50, 25, 25, EscalaRT3.T4));
        ...
        BotaoCor BTN_5 = mClicavel.criarBotaoCor(new BotaoCor(550, 50, 25, 25, EscalaRT3.T5));
        ...
        BotaoCor BTN_6 = mClicavel.criarBotaoCor(new BotaoCor(600, 50, 25, 25, EscalaRT3.T6));
        ...
        BotaoCor BTN_7 = mClicavel.criarBotaoCor(new BotaoCor(650, 50, 25, 25, EscalaRT3.T7));
        ...
        BotaoCor BTN_8 = mClicavel.criarBotaoCor(new BotaoCor(700, 50, 25, 25, EscalaRT3.T8));
        ...
        BotaoCor BTN_9 = mClicavel.criarBotaoCor(new BotaoCor(750, 50, 25, 25, EscalaRT3.T9));
        ...
        BotaoCor BTN_10 = mClicavel.criarBotaoCor(new BotaoCor(800, 50, 25, 25, EscalaRT3.T10));
        ...
        BotaoCor BTN_11 = mClicavel.criarBotaoCor(new BotaoCor(850, 50, 25, 25, EscalaRT3.T11));
        ...
        BotaoCor BTN_12 = mClicavel.criarBotaoCor(new BotaoCor(900, 50, 25, 25, EscalaRT3.T12));
        ...
        BotaoCor FRIO_BTN_0 = mClicavel.criarBotaoCor(new BotaoCor(300, 80, 25, 25, EscalaAQ4.T0));
        BTN_0.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_1 = mClicavel.criarBotaoCor(new BotaoCor(350, 80, 25, 25, EscalaAQ4.T1));
        BTN_1.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_2 = mClicavel.criarBotaoCor(new BotaoCor(400, 80, 25, 25, EscalaAQ4.T2));
        BTN_2.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_3 = mClicavel.criarBotaoCor(new BotaoCor(450, 80, 25, 25, EscalaAQ4.T3));
        BTN_3.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_4 = mClicavel.criarBotaoCor(new BotaoCor(500, 80, 25, 25, EscalaAQ4.T4));
        BTN_4.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_5 = mClicavel.criarBotaoCor(new BotaoCor(550, 80, 25, 25, EscalaAQ4.T5));
        BTN_5.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_6 = mClicavel.criarBotaoCor(new BotaoCor(600, 80, 25, 25, EscalaAQ4.T6));
        BTN_6.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_7 = mClicavel.criarBotaoCor(new BotaoCor(650, 80, 25, 25, EscalaAQ4.T7));
        BTN_7.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_8 = mClicavel.criarBotaoCor(new BotaoCor(700, 80, 25, 25, EscalaAQ4.T8));
        BTN_8.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_9 = mClicavel.criarBotaoCor(new BotaoCor(750, 80, 25, 25, EscalaAQ4.T9));
        BTN_9.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_10 = mClicavel.criarBotaoCor(new BotaoCor(800, 80, 25, 25, EscalaAQ4.T10));
        BTN_10.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_11 = mClicavel.criarBotaoCor(new BotaoCor(850, 80, 25, 25, EscalaAQ4.T11));
        BTN_11.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
        ...
        BotaoCor FRIO_BTN_12 = mClicavel.criarBotaoCor(new BotaoCor(900, 80, 25, 25, EscalaAQ4.T12));
        BTN_12.setAcao(new Acao() {
            @Override
            public void onClique() {
                ACAO_LIMPANTE.set(false);
    ...
    public void draw(Renderizador g) {
        ...
        for (Par<Ponto, Integer> relevo : mRelevo) {
            ...
            Cor eCor = EscalaRT3.GET_COR(relevo.getValor());
