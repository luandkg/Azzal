...
public class AtzumAppPlacasTectonicas extends Cena {
    ...
    private String ARQUIVO_NOME = LOCAL + "PLACAS_TECTONICAS.dkg";
        ...
        if (getWindows().getMouse().isClicked()) {
            ...
            if (mGPS_OK) {
                ...
                if (ACAO_LIMPANTE.get()) {
                    ...
                    AtzumPontosInteiro.SALVAR(mRelevo.toLista(), ARQUIVO_NOME);
                } else {
