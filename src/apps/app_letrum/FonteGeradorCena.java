...
import apps.app_letrum.Maker.FonteGerador;
...
public class FonteGeradorCena extends Cena {
    ...
    public void draw(Renderizador mRenderizador) {
        ...
        T10.escreva(100, 120, "Meu nome é libs.Luan Alves Freitas");
        T20.escreva(100, 150, "Meu nome é libs.Luan Alves Freitas");
        T30.escreva(100, 180, "Meu nome é libs.Luan Alves Freitas");

        V30.escreva(100, 300, "1 + 3 = 4 >>  { [ ( 2 + 2 ) / 2 ] * 4 }");

        T10.escreva(100, 400, "Meu nome é libs.Luan Alves Freitas");
