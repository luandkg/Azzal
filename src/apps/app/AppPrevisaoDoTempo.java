...
public class AppPrevisaoDoTempo {
    ...
    public static Lista<Entidade> init() {
        ...
        String previsao_do_tempo = Internet.GET_PAGINA_HTML(
        ...
        for (String frase : Strings.dividir_blocos(previsao_do_tempo, 100)) {
            // fmt.println(frase);
        }

        DKG documento = JSON.JSON_TO_DKG(previsao_do_tempo);
    ...
    public static ArrayList<Entidade> toEntidades() {
        ...
        ArrayList<Entidade> ents = new ArrayList<Entidade>();
    ...
    public static ArrayList<Entidade> toEntidadesTronarko() {
        ArrayList<Entidade> ents = toEntidades();
