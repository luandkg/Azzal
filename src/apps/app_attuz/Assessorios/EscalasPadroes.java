...
public class EscalasPadroes {
    ...
    public static Escala getEscalaDistancia() {
        ...
        mRelevoTerra.set(20, new Color(10, 10, 10).getRGB());
        mRelevoTerra.set(19, new Color(20, 20, 20).getRGB());
        mRelevoTerra.set(18, new Color(30, 30, 30).getRGB());
        mRelevoTerra.set(17, new Color(40, 40, 40).getRGB());
        mRelevoTerra.set(16, new Color(50, 50, 50).getRGB());
        mRelevoTerra.set(15, new Color(60, 60, 60).getRGB());
        mRelevoTerra.set(14, new Color(70, 70, 70).getRGB());
        mRelevoTerra.set(13, new Color(80, 80, 80).getRGB());
        mRelevoTerra.set(12, new Color(90, 90, 90).getRGB());
        mRelevoTerra.set(11, new Color(100, 100, 100).getRGB());
        mRelevoTerra.set(10, new Color(110, 110, 110).getRGB());
        mRelevoTerra.set(9, new Color(120, 120, 120).getRGB());
        mRelevoTerra.set(8, new Color(130, 130, 130).getRGB());
        mRelevoTerra.set(7, new Color(140, 140, 140).getRGB());
        mRelevoTerra.set(6, new Color(150, 150, 150).getRGB());
        mRelevoTerra.set(5, new Color(160, 160, 160).getRGB());
        mRelevoTerra.set(4, new Color(170, 170, 170).getRGB());
        mRelevoTerra.set(3, new Color(180, 180, 180).getRGB());
    ...
    public static Escala getEscalaPreciptacao() {

        Escala mRelevoTerra = new Escala(1, 6);

        mRelevoTerra.set(6, new Color(0, 0, 60).getRGB());
        mRelevoTerra.set(5, new Color(0, 0, 80).getRGB());
        mRelevoTerra.set(4, new Color(0, 0, 100).getRGB());
        mRelevoTerra.set(3, new Color(0, 0, 150).getRGB());
        mRelevoTerra.set(2, new Color(0, 0, 200).getRGB());
        mRelevoTerra.set(1, new Color(0, 0, 250).getRGB());
    ...
    public static Escala getEscalaBiomas() {

        Escala mRelevo = new Escala(1, 7);

        mRelevo.set(6, new Color(62, 140, 250).getRGB());

        mRelevo.set(5, new Color(150, 220, 15).getRGB());
        mRelevo.set(4, new Color(200, 200, 30).getRGB());

        mRelevo.set(3, new Color(62, 140, 170).getRGB());
        mRelevo.set(2, new Color(220, 60, 20).getRGB());

        mRelevo.set(1, new Color(140, 140, 140).getRGB());
